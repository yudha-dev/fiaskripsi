                ...
                <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            ...
                            <div <?php if (isset($_GET['page']) && $_GET['page'] == 'data_jasa') {
                                ...
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                    <li <?php if (isset($_GET['page']) && $_GET['page'] == 'data_jasa') {
                                            echo 'class="active"';
                                        } ?>>
                                        <a href="?page=data_jasa" class="nav-link">Data Jasa</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col ml--2">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div>
                                                        <h4 class="mb-0 text-sm"><?php echo $data['username'] ?></h4>
                                                    </div>
                            ...
                            <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body ml-2 d-none d-lg-block">
                                        <span class="mb-0 text-sm  font-weight-bold"><?php echo $data['username'] ?></span>
                                    </div>
                                </div>
                            </a>
