            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-white d-inline-block mb-0">Data Kategori Hiburan</h6>
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                <li class="breadcrumb-item"><a href="?page=dashboard"><i class="fas fa-home"></i></a></li>
                                <li class="breadcrumb-item"><a href="#">Kategori</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Data Kategori Hiburan</li>
                            </ol>
                        </nav>
                    </div>
                    ...
                    <div class="table-responsive py-4">
                        <table class="table table-flush" id="datatable-basic">
                            ...
                            <tbody>
                                ...
                                // Nomor urut
                                $no = 1;
                                //Query join dari table  kategori_hiburan dengan vendor
                                $data = mysqli_query($koneksi, "SELECT kategori_hiburan.id_hiburan,kategori_hiburan.id_vendor,kategori_hiburan.harga,kategori_hiburan.ket,kategori_hiburan.foto_hiburan,vendor.nama_vendor FROM kategori_hiburan INNER JOIN vendor ON kategori_hiburan.id_vendor = vendor.id_vendor");
                                while ($d = mysqli_fetch_array($data)) {
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="foto_kategori/foto_hiburan/<?php echo $d['foto_hiburan']; ?>" target="blank">
                                                <img src="foto_kategori/foto_hiburan/<?php echo $d['foto_hiburan']; ?>" width="100px" height="60px">
                                            </a></td>
                                        <td><a href="hapus_hiburan.php?id=<?php echo $d['id_hiburan'] ?>" type="button" class="btn btn-danger btn-xs">Hapus</a></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Tambah data kategori hiburan</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <form action="tambah_kategori_hiburan.php" method="post" name="Tambah" role="form" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="foto_hiburan" type="file" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
